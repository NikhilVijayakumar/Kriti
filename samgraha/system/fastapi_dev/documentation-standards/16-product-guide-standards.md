...
* How to add a new endpoint, following the layered architecture.
* How to create and run database migrations.
* How to manage and inject dependencies.
* Common architectural patterns used in the repository.
...
[Provide commands for running the dev server and accessing Swagger UI.]

### Testing and Linting

[Provide commands for running tests and linters.]
```
...
- **Don't:** Assume prior knowledge of the project's specific dependency manager.
