...
> *Structural rules: `audit/deterministic/section/08-external-context/06-backend_technology.yaml`*
...
```markdown
When documenting external context for a backend system, evaluate dependencies across these typical categories:

* **ORM / Database Abstraction:** Tools for data persistence and queries (e.g., SQLAlchemy).
* **Validation:** Data parsing and validation boundaries (e.g., Pydantic).
* **Authentication:** Identity verification and token management.
* **Caching & Background Jobs:** Async processing and performance layers.
...
**Correct:**
> We depend on SQLAlchemy as our ORM and Redis for caching.
...
- **Do:** Clearly identify the chosen technologies for backend categories.
- **Don't:** Describe internal implementation details.
