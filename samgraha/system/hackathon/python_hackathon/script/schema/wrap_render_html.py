"""wrap_render_html.py — samgraha adapter for run_html.py (usecase 6)."""
from _adapter import SCRIPTS_DIR, parse_step_args, run_driver, python_interpreter

DRIVER = SCRIPTS_DIR / "run_html.py"
...
def main():
    ...
    if payload.get("charts_dir"):
        argv += ["--charts-dir", payload["charts_dir"]]
