# Use-case 5e — Cross-Section Semantic Audit

**Depends on**: `document-narrative-polish` (4e — polished document ready
for cross-section consistency review)
...
- Rubric: `calculation/semantic/cross-section.yaml` — terminology
...
**Verify script**: `script/verify/uc5e_cross_section_audit.py --paper-id <id>`

**Rule**: Runs after 4e polish completes. Re-runs on any domain's
content changing (a targeted rewrite or humanize pass invalidates the last
cross-section run — re-run before proceeding to 5f).
