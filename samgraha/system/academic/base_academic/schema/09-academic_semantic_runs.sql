...
--
-- scope distinguishes four kinds of run:
--   'section-part'  — per-domain, per-part audit (domain_id NOT NULL)
--   'section-full'  — per-domain full audit (domain_id NOT NULL)
...
CREATE TABLE IF NOT EXISTS academic_semantic_runs (
    ...
    scope         TEXT    NOT NULL DEFAULT 'section-full'
