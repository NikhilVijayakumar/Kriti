...
- **Rubric**: `step1-draft-for-completeness/audit/rubric/{{ domain }}.md` — scoring criteria with weights and pass/fail thresholds
- **Draft**: `docs/paper/{{ system }}/domains/{{ domain }}.md` — current section draft to audit

## Task

1. Read the rubric from `step1-draft-for-completeness/audit/rubric/{{ domain }}.md`
...
- If the rubric file does not exist, return an error with `"error": "rubric not found: step1-draft-for-completeness/audit/rubric/{{ domain }}.md"`
