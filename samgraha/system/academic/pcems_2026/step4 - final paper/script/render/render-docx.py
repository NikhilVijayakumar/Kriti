...
def main():
    ...
    # html_path is .../paper-{id}/html/assembled.html - docx is a sibling
    # format folder, .../paper-{id}/docx/assembled.docx, not dumped next
    # to the html.
    docx_dir = html_path.parent.parent / "docx"
    docx_dir.mkdir(parents=True, exist_ok=True)
    docx_path = docx_dir / html_path.with_suffix(".docx").name
