You are drafting a "map proposal" for **algorithm entries** — a structured plan for extracting algorithm entries from the paper's source materials.
...
{{/candidate_files}}
{{^candidate_files}}
No source files found matching algorithms-related content.
{{/candidate_files}}
...
3. Per module, identify which files contain extractable algorithm entries and estimate how many per file — weight the primary module's findings as the main narrative, dependent modules as supporting/comparative context.
