You are drafting a "map proposal" for **novelty claims** — a structured plan for extracting novelty claims from the paper's source materials.
...
{{/candidate_files}}
{{^candidate_files}}
No source files found matching novelty-related content.
{{/candidate_files}}
...
3. Per module, identify which files contain extractable novelty claims and estimate how many per file — weight the primary module's findings as the main narrative, dependent modules as supporting/comparative context.
