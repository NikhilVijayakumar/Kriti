You are drafting a "map proposal" for **reference/citation entries** — a structured plan for extracting reference/citation entries from the paper's source materials.
...
{{/candidate_files}}
{{^candidate_files}}
No source files found matching references-related content.
{{/candidate_files}}
...
3. Per module, identify which files contain extractable reference/citation entries and estimate how many per file — weight the primary module's findings as the main narrative, dependent modules as supporting/comparative context.
