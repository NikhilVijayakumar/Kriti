You are drafting a "map proposal" for **gap entries** — a structured plan for extracting gap entries from the paper's source materials.
...
{{/candidate_files}}
{{^candidate_files}}
No source files found matching gaps-related content.
{{/candidate_files}}
...
3. Per module, identify which files contain extractable gap entries and estimate how many per file — weight the primary module's findings as the main narrative, dependent modules as supporting/comparative context.
