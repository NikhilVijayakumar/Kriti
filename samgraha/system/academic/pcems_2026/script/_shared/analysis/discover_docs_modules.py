        ...
        for system in docs_systems:
            ...
            for entry in sorted(modules_dir.iterdir()):
                ...
                academic_schema.upsert_module(
                    ...
                    metadata={"source": "docs", "docs_system": system})
            ...
            if cross_dir.is_dir():
                ...
                academic_schema.upsert_module(
                    ...
                    sort_order=sort_order,
                    metadata={"source": "docs", "kind": "cross_module", "docs_system": system})
        ...
        if combining:
            ...
            if cross_library_dir.is_dir():
                ...
                academic_schema.upsert_module(
                    ...
                    sort_order=sort_order,
                    metadata={"source": "docs", "kind": "cross_module", "docs_system": None})
                registered.append(pseudo)
                sort_order += 1
    finally:
        conn.close()
