...
`guide/Reviewer Expectations/03-strengthening-paper.md`:
...
| Results strength | No comparison | Basic comparison | Comprehensive with statistics |
...
Thresholds: Total <10 = Major revision. 10–14 = Targeted revision. 15–18 = Minor polish.
