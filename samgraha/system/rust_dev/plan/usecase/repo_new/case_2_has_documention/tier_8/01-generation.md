...
|---|---|---|
| readme | Migrate into `templates/generation/document/15-readme.md` shape | Generate from scratch |
| product-guide | Migrate into `templates/generation/document/16-product-guide.md` shape | Generate from scratch |
