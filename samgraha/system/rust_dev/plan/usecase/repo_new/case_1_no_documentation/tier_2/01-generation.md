...
|---|---|---|
| security | `templates/generation/document/03-security.md` | Vision, Philosophy |
...
| engineering | `templates/generation/document/07-engineering.md` | Philosophy |
| external-context | `templates/generation/document/08-external-context.md` | Vision |
