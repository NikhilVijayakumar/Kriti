...
|---|---|---|
| readme | `templates/generation/document/15-readme.md` | Vision, Build |
| product-guide | `templates/generation/document/16-product-guide.md` | All 11 upstream documents |
