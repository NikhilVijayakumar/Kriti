...
|---|---|---|
| readme | `templates/generation/document/15-readme.md` | Actual file paths, commands, configuration, entry points |
| product-guide | `templates/generation/document/16-product-guide.md` | All 11 upstream docs + actual features visible in code |
