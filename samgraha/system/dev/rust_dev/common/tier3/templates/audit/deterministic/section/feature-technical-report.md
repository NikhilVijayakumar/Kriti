...
**Rule Files:** `common/tier3/audit/deterministic/section/feature-technical/*.yaml`
...
| Section Rule Files | `common/tier3/audit/deterministic/section/feature-technical/*.yaml` |
| Auditor | System (deterministic engine) |
| Audit Date | {{ created_at }} |
| Revision | {{ revision_number }} |
| Session | {{ session_id }} |
