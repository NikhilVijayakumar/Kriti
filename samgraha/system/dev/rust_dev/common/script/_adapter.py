...
pcems's `paper_id` default and `--paper-id` verify-arg parsing: rust_dev
evaluates repos directly (repo_root is already the identity), it has no
"paper" concept to default.
"""
import argparse
import json
import os
