...
### Deterministic — Whole (`common/tier7/audit/deterministic/document/build.yaml`)
...
### Semantic — Whole (`common/tier7/audit/semantic/document/build.md`)
...
### Deterministic — Section (`common/tier7/audit/deterministic/section/build/*.yaml`)
...
### Semantic — Section (`common/tier7/audit/semantic/section/build/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`common/tier7/audit/deterministic/document/build.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`common/tier7/audit/deterministic/section/build/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`common/tier7/audit/semantic/document/build.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`common/tier7/audit/semantic/section/build/*.md`) |
