...
> **Domain:** build
> **Source standard:** `domain/14-build.md`
> **Coherence source:** `common/tier7/audit/semantic/document/build.md`
> **Relationships:** `common/tier7/audit/deterministic/document/build-relationships.yaml`
...
> Sourced from `common/tier7/audit/semantic/document/build.md` Engineering Intent.
