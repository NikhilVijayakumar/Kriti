...
> **Domain:** qa
> **Source standard:** `domain/12-qa.md`
> **Coherence source:** `common/tier6/audit/semantic/document/qa.md`
> **Relationships:** `common/tier6/audit/deterministic/document/qa-relationships.yaml`
...
| 5 | End-to-End Testing | `e2e_testing` | | Critical runtime workflows; expected outcomes; acceptance criteria; Feature-Technical(10) runtime behavior mapping |
...
> Sourced from `common/tier6/audit/semantic/document/qa.md` Engineering Intent.
...
> **Upstream relationships:** Feature(04) defines what to test; Architecture(05) defines boundaries; Feature-Technical(10) defines runtime behavior to validate; Security(03) defines security requirements.
...
> | Client request round-trip | Feature-Technical(10) §Runtime Behavior — Request Handling | Request routed through service layer and response returned | Response status matches contract; latency under budget |

**Incorrect example:**
> Test that the binary runs and doesn't crash.
> *Why wrong: critical runtime workflows must be mapped to specific Feature-Technical(10) references with explicit expected outcomes and measurable pass/fail criteria.*
...
- **Structure:** tables
- **Audience:** engineer
- **Do:** Link each workflow to a specific Feature-Technical(10) section; define expected outcomes as observable system states; write pass/fail criteria as automated assertions
