...
### Deterministic — Whole (`common/tier6/audit/deterministic/document/qa.yaml`)
...
### Semantic — Whole (`common/tier6/audit/semantic/document/qa.md`)
...
| C3 — E2E workflows traceable to Feature-Technical(10) runtime behavior | {{ doc_semantic.c3_display }} | {{ doc_semantic.c3_previous_display | default('—') }} | {{ doc_semantic.c3_trend_display }} |
...
### Deterministic — Section (`common/tier6/audit/deterministic/section/qa/*.yaml`)
...
### Semantic — Section (`common/tier6/audit/semantic/section/qa/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`common/tier6/audit/deterministic/document/qa.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`common/tier6/audit/deterministic/section/qa/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`common/tier6/audit/semantic/document/qa.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`common/tier6/audit/semantic/section/qa/*.md`) |
