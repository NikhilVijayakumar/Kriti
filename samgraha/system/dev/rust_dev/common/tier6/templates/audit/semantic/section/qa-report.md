...
**Rubric Files:** `common/tier6/audit/semantic/section/qa/*.md`
...
C1: critical runtime workflows named specifically, not "test the app". C2: expected outcomes and acceptance criteria stated per workflow. C3: workflows map to Feature-Technical(10)'s documented runtime behavior.
...
| Section Rubric Files | `common/tier6/audit/semantic/section/qa/*.md` |
| Auditor | LLM ({{ model_name }}) |
| Audit Date | {{ created_at }} |
| Revision | {{ revision_number }} |
| Session | {{ session_id }} |
