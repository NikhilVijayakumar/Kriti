...
**Standard:** `domain/05-architecture.md`
...
### Deterministic — Whole (`common/tier2/audit/deterministic/document/architecture.yaml`)
...
### Semantic — Whole (`common/tier2/audit/semantic/document/architecture.md`)
...
### Deterministic — Section (`common/tier2/audit/deterministic/section/architecture/*.yaml`)
...
### Semantic — Section (`common/tier2/audit/semantic/section/architecture/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`common/tier2/audit/deterministic/document/architecture.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`common/tier2/audit/deterministic/section/architecture/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`common/tier2/audit/semantic/document/architecture.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`common/tier2/audit/semantic/section/architecture/*.md`) |
