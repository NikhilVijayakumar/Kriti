# Audit Summary — External Context

**Document:** {{ document_path }}
**Standard:** `domain/08-external-context.md`
...
### Deterministic — Whole (`common/tier2/audit/deterministic/document/external-context.yaml`)
...
### Semantic — Whole (`common/tier2/audit/semantic/document/external-context.md`)
...
### Deterministic — Section (`common/tier2/audit/deterministic/section/external-context/*.yaml`)
...
| 2 | Integration Contract | **required** | {{ sections.integration_contract.det_score }} / 100 | {{ sections.integration_contract.det_previous_score | default('—') }} | {{ sections.integration_contract.det_trend_display }} |
| 3 | Constraints | optional | {{ sections.constraints.det_score }} / 100 | {{ sections.constraints.det_previous_score | default('—') }} | {{ sections.constraints.det_trend_display }} |
| 4 | Dependencies | optional | {{ sections.dependencies.det_score }} / 100 | {{ sections.dependencies.det_previous_score | default('—') }} | {{ sections.dependencies.det_trend_display }} |
| 5 | Traceability | optional | {{ sections.traceability.det_score }} / 100 | {{ sections.traceability.det_previous_score | default('—') }} | {{ sections.traceability.det_trend_display }} |

### Semantic — Section (`common/tier2/audit/semantic/section/external-context/*.md`)
...
| 2 | Integration Contract | **required** | {{ sections.integration_contract.sem_score }} / 100 | {{ sections.integration_contract.sem_previous_score | default('—') }} | {{ sections.integration_contract.sem_trend_display }} |
| 3 | Constraints | optional | {{ sections.constraints.sem_score }} / 100 | {{ sections.constraints.sem_previous_score | default('—') }} | {{ sections.constraints.sem_trend_display }} |
| 4 | Dependencies | optional | {{ sections.dependencies.sem_score }} / 100 | {{ sections.dependencies.sem_previous_score | default('—') }} | {{ sections.dependencies.sem_trend_display }} |
| 5 | Traceability | optional | {{ sections.traceability.sem_score }} / 100 | {{ sections.traceability.sem_previous_score | default('—') }} | {{ sections.traceability.sem_trend_display }} |
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`common/tier2/audit/deterministic/document/external-context.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`common/tier2/audit/deterministic/section/external-context/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`common/tier2/audit/semantic/document/external-context.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`common/tier2/audit/semantic/section/external-context/*.md`) |
