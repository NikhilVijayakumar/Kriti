# Audit Summary — Engineering

**Document:** {{ document_path }}
**Standard:** `domain/07-engineering.md`
...
### Deterministic — Whole (`common/tier2/audit/deterministic/document/engineering.yaml`)
...
### Semantic — Whole (`common/tier2/audit/semantic/document/engineering.md`)
...
### Deterministic — Section (`common/tier2/audit/deterministic/section/engineering/*.yaml`)
...
| 2 | Rationale | **required** | {{ sections.rationale.det_score }} / 100 | {{ sections.rationale.det_previous_score | default('—') }} | {{ sections.rationale.det_trend_display }} |
| 3 | Build Standards | **required** | {{ sections.build_standards.det_score }} / 100 | {{ sections.build_standards.det_previous_score | default('—') }} | {{ sections.build_standards.det_trend_display }} |
| 4 | Testing Standards | **required** | {{ sections.testing_standards.det_score }} / 100 | {{ sections.testing_standards.det_previous_score | default('—') }} | {{ sections.testing_standards.det_trend_display }} |
...
| 6 | Code Standards | optional | {{ sections.code_standards.det_score }} / 100 | {{ sections.code_standards.det_previous_score | default('—') }} | {{ sections.code_standards.det_trend_display }} |
...
| 8 | Traceability | optional | {{ sections.traceability.det_score }} / 100 | {{ sections.traceability.det_previous_score | default('—') }} | {{ sections.traceability.det_trend_display }} |

### Semantic — Section (`common/tier2/audit/semantic/section/engineering/*.md`)
...
| 2 | Rationale | **required** | {{ sections.rationale.sem_score }} / 100 | {{ sections.rationale.sem_previous_score | default('—') }} | {{ sections.rationale.sem_trend_display }} |
| 3 | Build Standards | **required** | {{ sections.build_standards.sem_score }} / 100 | {{ sections.build_standards.sem_previous_score | default('—') }} | {{ sections.build_standards.sem_trend_display }} |
| 4 | Testing Standards | **required** | {{ sections.testing_standards.sem_score }} / 100 | {{ sections.testing_standards.sem_previous_score | default('—') }} | {{ sections.testing_standards.sem_trend_display }} |
...
| 6 | Code Standards | optional | {{ sections.code_standards.sem_score }} / 100 | {{ sections.code_standards.sem_previous_score | default('—') }} | {{ sections.code_standards.sem_trend_display }} |
...
| 8 | Traceability | optional | {{ sections.traceability.sem_score }} / 100 | {{ sections.traceability.sem_previous_score | default('—') }} | {{ sections.traceability.sem_trend_display }} |
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`common/tier2/audit/deterministic/document/engineering.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`common/tier2/audit/deterministic/section/engineering/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`common/tier2/audit/semantic/document/engineering.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`common/tier2/audit/semantic/section/engineering/*.md`) |
