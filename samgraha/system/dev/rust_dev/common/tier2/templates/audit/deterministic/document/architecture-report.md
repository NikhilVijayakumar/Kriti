...
**Rule File:** `common/tier2/audit/deterministic/document/architecture.yaml`
...
Total possible weight across all 6 document-level rules is fixed at **5.0** (arch-doc-001 1.5, 002 1.0, 003 0.5, 004 1.0, 005 0.5, 006 0.5 — see `common/tier2/audit/deterministic/document/architecture.yaml`). Mandatory rules (001, 002, 004 — combined weight 3.5 of 5.0) carry most of the score; a single mandatory failure is a heavier hit than any one recommended failure, by design.
