...
> **Source standard:** `domain/08-external-context.md`
> **Coherence source:** `common/tier2/audit/semantic/document/external-context.md`
> **Relationships:** `common/tier2/audit/deterministic/document/external-context-relationships.yaml`
...
> Sourced from `common/tier2/audit/semantic/document/external-context.md` Engineering Intent.
