...
> **Source:** `domain/07-engineering.md` §Engineering Principles
...
| `derives_from` | philosophy / tradeoffs | Engineering Principles must derive from the product's tradeoffs |
