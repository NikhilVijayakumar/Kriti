...
> **Domain:** security
> **Source standard:** `domain/03-security.md`
> **Coherence source:** `common/tier2/audit/semantic/document/security.md`
> **Relationships:** `common/tier2/audit/deterministic/document/security-relationships.yaml`
...
> Sourced from `common/tier2/audit/semantic/document/security.md` Engineering Intent.
