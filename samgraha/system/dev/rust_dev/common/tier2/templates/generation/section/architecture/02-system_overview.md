...
> **Source:** `domain/05-architecture.md` §System Overview
> **Relationships:** `common/tier2/audit/deterministic/document/architecture-relationships.yaml`
...
**Incorrect:**
> DataSync uses Tokio 1.x with Axum 0.7 for event streaming, sqlx with PostgreSQL 15 for metadata storage, and Redis 7 for caching. The backend runs on AWS EKS with Kubernetes 1.27.
