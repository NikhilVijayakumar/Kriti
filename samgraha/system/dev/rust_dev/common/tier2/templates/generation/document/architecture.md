...
> **Domain:** architecture
> **Source standard:** `domain/05-architecture.md`
> **Coherence source:** `common/tier2/audit/semantic/document/architecture.md`
...
> Sourced from `common/tier2/audit/semantic/document/architecture.md` Engineering Intent.
