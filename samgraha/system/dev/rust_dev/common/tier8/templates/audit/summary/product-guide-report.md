...
**Standard:** `domain/16-product-guide.md`
...
### Deterministic — Whole (`common/tier8/audit/deterministic/document/product-guide.yaml`)
...
### Semantic — Whole (`common/tier8/audit/semantic/document/product-guide.md`)
...
### Deterministic — Section (`common/tier8/audit/deterministic/section/product-guide/*.yaml`)
...
### Semantic — Section (`common/tier8/audit/semantic/section/product-guide/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`common/tier8/audit/deterministic/document/product-guide.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`common/tier8/audit/deterministic/section/product-guide/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`common/tier8/audit/semantic/document/product-guide.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`common/tier8/audit/semantic/section/product-guide/*.md`) |
