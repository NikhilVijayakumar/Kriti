...
### Deterministic — Whole (`common/tier8/audit/deterministic/document/readme.yaml`)
...
### Semantic — Whole (`common/tier8/audit/semantic/document/readme.md`)
...
### Deterministic — Section (`common/tier8/audit/deterministic/section/readme/*.yaml`)
...
### Semantic — Section (`common/tier8/audit/semantic/section/readme/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`common/tier8/audit/deterministic/document/readme.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`common/tier8/audit/deterministic/section/readme/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`common/tier8/audit/semantic/document/readme.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`common/tier8/audit/semantic/section/readme/*.md`) |
