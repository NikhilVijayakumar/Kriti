...
> **Source standard:** `domain/16-product-guide.md`
> **Coherence source:** `common/tier8/audit/semantic/document/product-guide.md`
> **Relationships:** `common/tier8/audit/deterministic/document/product-guide-relationships.yaml`
...
> Sourced from `common/tier8/audit/semantic/document/product-guide.md` Engineering Intent.
