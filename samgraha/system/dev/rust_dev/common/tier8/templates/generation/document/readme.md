...
> **Domain:** readme
> **Source standard:** `domain/15-readme.md`
> **Coherence source:** `common/tier8/audit/semantic/document/readme.md`
> **Relationships:** `common/tier8/audit/deterministic/document/readme-relationships.yaml`
...
> Sourced from `common/tier8/audit/semantic/document/readme.md` Engineering Intent.
...
> ```
>
> Produces `target/release/acme-scheduler`.
