...
> **Source:** `domain/16-product-guide.md` §DevelopmentWorkflow
...
> *Structural rules: `common/tier8/audit/deterministic/section/product-guide/07-development_workflow.yaml`*
