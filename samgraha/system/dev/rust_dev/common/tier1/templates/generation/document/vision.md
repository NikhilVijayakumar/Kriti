...
> **Domain:** vision
> **Source standard:** `domain/01-vision.md`
> **Coherence source:** `common/tier1/audit/semantic/document/vision.md`
> **Relationships:** `common/tier1/audit/deterministic/document/vision-relationships.yaml`
...
> Sourced from `common/tier1/audit/semantic/document/vision.md` Engineering Intent.
...
> *Why wrong: These are vanity metrics with no connection to the Vision — lines of code say nothing about value delivered, and star counts measure popularity, not product success.*
