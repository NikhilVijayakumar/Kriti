...
**Standard:** `domain/02-philosophy.md`
...
### Deterministic — Whole (`common/tier1/audit/deterministic/document/philosophy.yaml`)
...
### Semantic — Whole (`common/tier1/audit/semantic/document/philosophy.md`)
...
### Deterministic — Section (`common/tier1/audit/deterministic/section/philosophy/*.yaml`)
...
### Semantic — Section (`common/tier1/audit/semantic/section/philosophy/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`common/tier1/audit/deterministic/document/philosophy.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`common/tier1/audit/deterministic/section/philosophy/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`common/tier1/audit/semantic/document/philosophy.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`common/tier1/audit/semantic/section/philosophy/*.md`) |
