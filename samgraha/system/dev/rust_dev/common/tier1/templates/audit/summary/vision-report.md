...
### Deterministic â€” Whole (`common/tier1/audit/deterministic/document/vision.yaml`)
...
### Semantic â€” Whole (`common/tier1/audit/semantic/document/vision.md`)
...
### Deterministic â€” Section (`common/tier1/audit/deterministic/section/vision/*.yaml`)
...
### Semantic â€” Section (`common/tier1/audit/semantic/section/vision/*.md`)
...
| Report | File |
|---|---|
| Deterministic â€” Whole | `{{ det_whole_report_path }}` (`common/tier1/audit/deterministic/document/vision.yaml`) |
| Deterministic â€” Section | `{{ det_section_report_path }}` (`common/tier1/audit/deterministic/section/vision/*.yaml`) |
| Semantic â€” Whole | `{{ sem_whole_report_path }}` (`common/tier1/audit/semantic/document/vision.md`) |
| Semantic â€” Section | `{{ sem_section_report_path }}` (`common/tier1/audit/semantic/section/vision/*.md`) |
