# Audit Summary — Implementation

**Document:** {{ document_path }}
**Standard:** `domain/13-implementation.md`
...
### Deterministic — Whole (`common/tier5/audit/deterministic/document/implementation.yaml`)
...
### Semantic — Whole (`common/tier5/audit/semantic/document/implementation.md`)

| Criterion | Result | Previous | Trend |
|---|---|---|---|
| C1 — Cross-plan consistency | {{ doc_semantic.c1_display }} | {{ doc_semantic.c1_previous_display | default('—') }} | {{ doc_semantic.c1_trend_display }} |
...
### Deterministic — Section (`common/tier5/audit/deterministic/section/implementation/*.yaml`)

| # | Section | Required | Score | Previous | Trend |
|---:|---|:---:|---:|---:|---|
| 1 | Generation Plan | **required** | {{ sections.generation_plan.det_score }} / 100 | {{ sections.generation_plan.det_previous_score | default('—') }} | {{ sections.generation_plan.det_trend_display }} |
| 2 | Security Fix Plan | **required** | {{ sections.security_fix_plan.det_score }} / 100 | {{ sections.security_fix_plan.det_previous_score | default('—') }} | {{ sections.security_fix_plan.det_trend_display }} |
...
| 4 | Refactor Plan | optional | {{ sections.refactor_plan.det_score }} / 100 | {{ sections.refactor_plan.det_previous_score | default('—') }} | {{ sections.refactor_plan.det_trend_display }} |
| 5 | Change Request Plan | optional | {{ sections.change_request_plan.det_score }} / 100 | {{ sections.change_request_plan.det_previous_score | default('—') }} | {{ sections.change_request_plan.det_trend_display }} |
| 6 | Enhancement Plan | optional | {{ sections.enhancement_plan.det_score }} / 100 | {{ sections.enhancement_plan.det_previous_score | default('—') }} | {{ sections.enhancement_plan.det_trend_display }} |

### Semantic — Section (`common/tier5/audit/semantic/section/implementation/*.md`)

| # | Section | Required | Score | Previous | Trend |
|---:|---|:---:|---:|---:|---|
| 1 | Generation Plan | **required** | {{ sections.generation_plan.sem_score }} / 100 | {{ sections.generation_plan.sem_previous_score | default('—') }} | {{ sections.generation_plan.sem_trend_display }} |
| 2 | Security Fix Plan | **required** | {{ sections.security_fix_plan.sem_score }} / 100 | {{ sections.security_fix_plan.sem_previous_score | default('—') }} | {{ sections.security_fix_plan.sem_trend_display }} |
...
| 4 | Refactor Plan | optional | {{ sections.refactor_plan.sem_score }} / 100 | {{ sections.refactor_plan.sem_previous_score | default('—') }} | {{ sections.refactor_plan.sem_trend_display }} |
| 5 | Change Request Plan | optional | {{ sections.change_request_plan.sem_score }} / 100 | {{ sections.change_request_plan.sem_previous_score | default('—') }} | {{ sections.change_request_plan.sem_trend_display }} |
| 6 | Enhancement Plan | optional | {{ sections.enhancement_plan.sem_score }} / 100 | {{ sections.enhancement_plan.sem_previous_score | default('—') }} | {{ sections.enhancement_plan.sem_trend_display }} |
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`common/tier5/audit/deterministic/document/implementation.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`common/tier5/audit/deterministic/section/implementation/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`common/tier5/audit/semantic/document/implementation.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`common/tier5/audit/semantic/section/implementation/*.md`) |
