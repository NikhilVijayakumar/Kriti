...
> **Source standard:** `domain/13-implementation.md`
> **Coherence source:** `common/tier5/audit/semantic/document/implementation.md`
> **Relationships:** `common/tier5/audit/deterministic/document/implementation-relationships.yaml`
...
> Sourced from `common/tier5/audit/semantic/document/implementation.md` Engineering Intent.
...
|---|---|---|---|
| [module/component] | [Feature(04), Feature Technical(10), etc.] | [what changes] | [what to update] |
