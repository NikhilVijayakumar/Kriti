...
> **Source:** `domain/13-implementation.md` §CrateFolderStructure
...
> *Structural rules: `common/tier5/audit/deterministic/section/implementation/08-crate_folder_structure.yaml`*
