...
> **Source:** `domain/13-implementation.md` §Change Request Plan
...
| `derives_from` | feature-technical / runtime_behavior | Change must align with updated Feature Technical(10) runtime behavior |
