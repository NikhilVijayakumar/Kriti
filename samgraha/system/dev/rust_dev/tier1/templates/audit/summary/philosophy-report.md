...
### Deterministic — Whole (`tier1/audit/deterministic/document/philosophy.yaml`)
...
### Semantic — Whole (`tier1/audit/semantic/document/philosophy.md`)
...
### Deterministic — Section (`tier1/audit/deterministic/section/philosophy/*.yaml`)
...
### Semantic — Section (`tier1/audit/semantic/section/philosophy/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`tier1/audit/deterministic/document/philosophy.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`tier1/audit/deterministic/section/philosophy/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`tier1/audit/semantic/document/philosophy.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`tier1/audit/semantic/section/philosophy/*.md`) |
