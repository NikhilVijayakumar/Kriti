...
|---|---|---|
| vision | Depends on scenario | If yes → migrate: restructure existing prose into `tier1/templates/generation/document/vision.md`'s section shape. If no → generate from scratch. |
| philosophy | Depends on scenario | If yes → migrate: restructure existing prose into `tier1/templates/generation/document/philosophy.md`'s section shape. If no → generate from scratch. |
