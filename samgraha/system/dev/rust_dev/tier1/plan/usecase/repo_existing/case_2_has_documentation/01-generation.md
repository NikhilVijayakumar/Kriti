...
Existing repo with real code and existing non-conforming documentation. Tier 1 domains have hand-written docs that don't conform to `domain/`. Stage 1 is migration — restructure existing prose into the template shape.
...
|---|---|---|
| vision | Existing Vision doc | `tier1/templates/generation/document/vision.md` |
| philosophy | Existing Philosophy doc | `tier1/templates/generation/document/philosophy.md` |
