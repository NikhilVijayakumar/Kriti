...
Once every domain in Tier 3 (feature-technical) has final score ≥ the Acceptable band minimum, the tier clears and Tier 5 can begin.

## Differs From Other Use Cases

No difference across the 3-way split (repo_new/tier3, repo_existing/tier3, repo_existing_no_doc/tier3) - same fix procedure.