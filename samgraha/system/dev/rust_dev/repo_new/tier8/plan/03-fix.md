...
Once every domain in Tier 8 (readme, product-guide) has final score ≥ the Acceptable band minimum, the tier clears. **This is the finish line** → all 16 domains across all 8 tiers have cleared their gates. The repository's documentation is compliant.

## Differs From Other Use Cases

No difference across the 3-way split (repo_new/tier8, repo_existing/tier8, repo_existing_no_doc/tier8) - same fix procedure.