...
**Standard:** `domain/implementation.md`
...
### Deterministic — Whole (`tier5/audit/deterministic/document/implementation.yaml`)
...
### Semantic — Whole (`tier5/audit/semantic/document/implementation.md`)
...
### Deterministic — Section (`tier5/audit/deterministic/section/implementation/*.yaml`)
...
### Semantic — Section (`tier5/audit/semantic/section/implementation/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`tier5/audit/deterministic/document/implementation.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`tier5/audit/deterministic/section/implementation/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`tier5/audit/semantic/document/implementation.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`tier5/audit/semantic/section/implementation/*.md`) |
