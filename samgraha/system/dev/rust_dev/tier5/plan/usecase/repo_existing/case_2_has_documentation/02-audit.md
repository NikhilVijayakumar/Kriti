...
|---|---|---|---|
| implementation | `folder-structure`, `dependency-manifest`, `lint-pass` | `tier5/audit/deterministic/document/implementation.yaml` | `tier5/audit/semantic/document/implementation.md` |
