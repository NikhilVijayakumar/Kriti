...
|---|---|---|
| implementation | `tier5/templates/generation/document/implementation.md` | Cross-reference existing implementation doc against actual code — flag gaps and inaccuracies |
