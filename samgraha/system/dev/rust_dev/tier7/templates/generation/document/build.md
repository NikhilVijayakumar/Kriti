...
> **Domain:** build
> **Source standard:** `domain/build.md`
> **Coherence source:** `tier7/audit/semantic/document/build.md`
> **Relationships:** `tier7/audit/deterministic/document/build-relationships.yaml`
...
> Sourced from `tier7/audit/semantic/document/build.md` Engineering Intent.
