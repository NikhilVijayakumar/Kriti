...
### Deterministic — Whole (`tier7/audit/deterministic/document/build.yaml`)
...
### Semantic — Whole (`tier7/audit/semantic/document/build.md`)
...
### Deterministic — Section (`tier7/audit/deterministic/section/build/*.yaml`)
...
### Semantic — Section (`tier7/audit/semantic/section/build/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`tier7/audit/deterministic/document/build.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`tier7/audit/deterministic/section/build/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`tier7/audit/semantic/document/build.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`tier7/audit/semantic/section/build/*.md`) |
