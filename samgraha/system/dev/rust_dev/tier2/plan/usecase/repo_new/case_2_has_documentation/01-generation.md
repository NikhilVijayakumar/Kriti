...
|---|---|---|
| security | Migrate into `tier2/templates/generation/document/security.md` shape | Generate from scratch |
| feature | Migrate into `tier2/templates/generation/document/feature.md` shape | Generate from scratch |
| architecture | Migrate into `tier2/templates/generation/document/architecture.md` shape | Generate from scratch |
| engineering | Migrate into `tier2/templates/generation/document/engineering.md` shape | Generate from scratch |
| external-context | Migrate into `tier2/templates/generation/document/external-context.md` shape | Generate from scratch |
