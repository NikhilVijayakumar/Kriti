...
|---|---|---|
| security | `tier2/templates/generation/document/security.md` | Vision, Philosophy |
| feature | `tier2/templates/generation/document/feature.md` | Vision, Philosophy |
| architecture | `tier2/templates/generation/document/architecture.md` | Philosophy |
| engineering | `tier2/templates/generation/document/engineering.md` | Philosophy |
| external-context | `tier2/templates/generation/document/external-context.md` | Vision |
