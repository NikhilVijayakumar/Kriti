...
1. **Deterministic document audit:** Run `tier2/audit/deterministic/document/{domain}.yaml` against the document.
2. **Deterministic section audit:** Run `tier2/audit/deterministic/section/{domain}/*.yaml` against each section.
3. **Semantic document audit:** Run `tier2/audit/semantic/document/{domain}.md` against the whole document.
4. **Semantic section audit:** Run `tier2/audit/semantic/section/{domain}/*.md` against each section.
