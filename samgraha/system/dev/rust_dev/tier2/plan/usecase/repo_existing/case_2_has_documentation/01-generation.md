...
|---|---|---|
| security | `tier2/templates/generation/document/security.md` | Check auth/permissions against actual code |
| feature | `tier2/templates/generation/document/feature.md` | Check feature list against actual functionality |
| architecture | `tier2/templates/generation/document/architecture.md` | Verify structure against actual directory layout |
| engineering | `tier2/templates/generation/document/engineering.md` | Verify practices against actual config |
| external-context | `tier2/templates/generation/document/external-context.md` | Not code-dependent |
...
Five documents, ready for stage 2 (audit).
...
- **vs. `repo_new/case_2_has_documentation`:** Real code context available for verification.
