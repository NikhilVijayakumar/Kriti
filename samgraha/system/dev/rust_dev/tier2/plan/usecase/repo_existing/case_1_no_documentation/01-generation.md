...
|---|---|---|---|
| security | `tier2/templates/generation/document/security.md` | Vision, Philosophy | Existing auth, permissions, dependency audit results |
| feature | `tier2/templates/generation/document/feature.md` | Vision, Philosophy | Existing feature set visible in code |
| architecture | `tier2/templates/generation/document/architecture.md` | Philosophy | Actual directory structure, module boundaries, dependency graph |
| engineering | `tier2/templates/generation/document/engineering.md` | Philosophy | Actual language, frameworks, linting config, test setup |
| external-context | `tier2/templates/generation/document/external-context.md` | Vision | Market analysis — not code-dependent |
...
Five documents, ready for stage 2 (audit). No scoring at this stage.
