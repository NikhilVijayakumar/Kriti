...
> **Domain:** security
> **Source standard:** `domain/security.md`
> **Coherence source:** `tier2/audit/semantic/document/security.md`
> **Relationships:** `tier2/audit/deterministic/document/security-relationships.yaml`
...
> Sourced from `tier2/audit/semantic/document/security.md` Engineering Intent.
