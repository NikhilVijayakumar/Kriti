...
> **Source standard:** `domain/external-context.md`
> **Coherence source:** `tier2/audit/semantic/document/external-context.md`
> **Relationships:** `tier2/audit/deterministic/document/external-context-relationships.yaml`
...
> Sourced from `tier2/audit/semantic/document/external-context.md` Engineering Intent.
