...
> **Domain:** architecture
> **Source standard:** `domain/architecture.md`
> **Coherence source:** `tier2/audit/semantic/document/architecture.md`
...
> Sourced from `tier2/audit/semantic/document/architecture.md` Engineering Intent.
