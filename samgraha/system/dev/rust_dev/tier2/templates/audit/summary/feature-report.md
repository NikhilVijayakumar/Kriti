...
### Deterministic — Whole (`tier2/audit/deterministic/document/feature.yaml`)
...
### Semantic — Whole (`tier2/audit/semantic/document/feature.md`)
...
### Deterministic — Section (`tier2/audit/deterministic/section/feature/*.yaml`)
...
### Semantic — Section (`tier2/audit/semantic/section/feature/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`tier2/audit/deterministic/document/feature.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`tier2/audit/deterministic/section/feature/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`tier2/audit/semantic/document/feature.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`tier2/audit/semantic/section/feature/*.md`) |
