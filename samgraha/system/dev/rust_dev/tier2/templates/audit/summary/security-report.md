...
### Deterministic — Whole (`tier2/audit/deterministic/document/security.yaml`)
...
### Semantic — Whole (`tier2/audit/semantic/document/security.md`)
...
### Deterministic — Section (`tier2/audit/deterministic/section/security/*.yaml`)
...
### Semantic — Section (`tier2/audit/semantic/section/security/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`tier2/audit/deterministic/document/security.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`tier2/audit/deterministic/section/security/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`tier2/audit/semantic/document/security.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`tier2/audit/semantic/section/security/*.md`) |
