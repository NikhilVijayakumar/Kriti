...
**Standard:** `domain/architecture.md`
...
### Deterministic — Whole (`tier2/audit/deterministic/document/architecture.yaml`)
...
### Semantic — Whole (`tier2/audit/semantic/document/architecture.md`)
...
### Deterministic — Section (`tier2/audit/deterministic/section/architecture/*.yaml`)
...
### Semantic — Section (`tier2/audit/semantic/section/architecture/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`tier2/audit/deterministic/document/architecture.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`tier2/audit/deterministic/section/architecture/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`tier2/audit/semantic/document/architecture.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`tier2/audit/semantic/section/architecture/*.md`) |
