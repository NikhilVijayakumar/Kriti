...
**Standard:** `domain/engineering.md`
...
### Deterministic — Whole (`tier2/audit/deterministic/document/engineering.yaml`)
...
### Semantic — Whole (`tier2/audit/semantic/document/engineering.md`)
...
### Deterministic — Section (`tier2/audit/deterministic/section/engineering/*.yaml`)
...
### Semantic — Section (`tier2/audit/semantic/section/engineering/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`tier2/audit/deterministic/document/engineering.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`tier2/audit/deterministic/section/engineering/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`tier2/audit/semantic/document/engineering.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`tier2/audit/semantic/section/engineering/*.md`) |
