...
**Standard:** `domain/external-context.md`
...
### Deterministic — Whole (`tier2/audit/deterministic/document/external-context.yaml`)
...
### Semantic — Whole (`tier2/audit/semantic/document/external-context.md`)
...
### Deterministic — Section (`tier2/audit/deterministic/section/external-context/*.yaml`)
...
### Semantic — Section (`tier2/audit/semantic/section/external-context/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`tier2/audit/deterministic/document/external-context.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`tier2/audit/deterministic/section/external-context/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`tier2/audit/semantic/document/external-context.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`tier2/audit/semantic/section/external-context/*.md`) |
