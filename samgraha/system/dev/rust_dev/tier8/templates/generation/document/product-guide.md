...
> **Source standard:** `domain/product-guide.md`
> **Coherence source:** `tier8/audit/semantic/document/product-guide.md`
> **Relationships:** `tier8/audit/deterministic/document/product-guide-relationships.yaml`
...
> Sourced from `tier8/audit/semantic/document/product-guide.md` Engineering Intent.
