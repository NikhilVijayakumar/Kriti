...
**Standard:** `domain/product-guide.md`
...
### Deterministic — Whole (`tier8/audit/deterministic/document/product-guide.yaml`)
...
### Semantic — Whole (`tier8/audit/semantic/document/product-guide.md`)
...
### Deterministic — Section (`tier8/audit/deterministic/section/product-guide/*.yaml`)
...
### Semantic — Section (`tier8/audit/semantic/section/product-guide/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`tier8/audit/deterministic/document/product-guide.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`tier8/audit/deterministic/section/product-guide/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`tier8/audit/semantic/document/product-guide.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`tier8/audit/semantic/section/product-guide/*.md`) |
