...
**Rule File:** `tier8/audit/deterministic/document/product-guide.yaml`
...
Total possible weight across all 5 document-level rules is fixed at **4.5** (pg-doc-001 1.5, 002 1.0, 003 0.5, 004 1.0, 005 0.5 — see `tier8/audit/deterministic/document/product-guide.yaml`). Mandatory rules (001, 002, 004 — combined weight 3.5 of 4.5) carry most of the score; a single mandatory failure is a heavier hit than any one recommended failure, by design.
