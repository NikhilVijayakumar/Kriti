...
Existing repo with real code but no documentation. Tiers 1–7 have completed — all 11 upstream documents exist and have cleared their tier gates. Tier 8 is the final tier.
...
|---|---|---|
| readme | `tier8/templates/generation/document/readme.md` | Actual file paths, commands, configuration, entry points |
| product-guide | `tier8/templates/generation/document/product-guide.md` | All 11 upstream docs + actual features visible in code |
