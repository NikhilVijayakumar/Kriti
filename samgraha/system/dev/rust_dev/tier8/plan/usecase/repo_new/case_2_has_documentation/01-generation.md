...
New repo with some pre-existing hand-written documentation. No code. Tiers 1–7 have completed — all 11 upstream documents exist and have cleared their tier gates. Tier 8 is the final tier.
...
|---|---|---|
| readme | Migrate into `tier8/templates/generation/document/readme.md` shape | Generate from scratch |
| product-guide | Migrate into `tier8/templates/generation/document/product-guide.md` shape | Generate from scratch |
