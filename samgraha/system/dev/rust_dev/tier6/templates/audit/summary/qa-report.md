...
### Deterministic — Whole (`tier6/audit/deterministic/document/qa.yaml`)
...
### Semantic — Whole (`tier6/audit/semantic/document/qa.md`)
...
### Deterministic — Section (`tier6/audit/deterministic/section/qa/*.yaml`)
...
### Semantic — Section (`tier6/audit/semantic/section/qa/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`tier6/audit/deterministic/document/qa.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`tier6/audit/deterministic/section/qa/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`tier6/audit/semantic/document/qa.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`tier6/audit/semantic/section/qa/*.md`) |
