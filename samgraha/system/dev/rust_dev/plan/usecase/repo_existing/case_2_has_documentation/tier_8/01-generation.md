...
|---|---|---|
| readme | `templates/generation/document/15-readme.md` | Verify file paths, commands, config against actual codebase |
| product-guide | `templates/generation/document/16-product-guide.md` | Verify feature descriptions against actual functionality |
