...
### Deterministic — Whole (`tier3/audit/deterministic/document/feature-technical.yaml`)
...
### Semantic — Whole (`tier3/audit/semantic/document/feature-technical.md`)
...
### Deterministic — Section (`tier3/audit/deterministic/section/feature-technical/*.yaml`)
...
### Semantic — Section (`tier3/audit/semantic/section/feature-technical/*.md`)
...
| Report | File |
|---|---|
| Deterministic — Whole | `{{ det_whole_report_path }}` (`tier3/audit/deterministic/document/feature-technical.yaml`) |
| Deterministic — Section | `{{ det_section_report_path }}` (`tier3/audit/deterministic/section/feature-technical/*.yaml`) |
| Semantic — Whole | `{{ sem_whole_report_path }}` (`tier3/audit/semantic/document/feature-technical.md`) |
| Semantic — Section | `{{ sem_section_report_path }}` (`tier3/audit/semantic/section/feature-technical/*.md`) |
