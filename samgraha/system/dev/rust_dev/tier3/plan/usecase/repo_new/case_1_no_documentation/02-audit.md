...
|---|---|---|---|---|---|
| feature-technical | `integration-points-exist` | `tier3/audit/deterministic/document/feature-technical.yaml` | `tier3/audit/deterministic/section/feature-technical/*.yaml` | `tier3/audit/semantic/document/feature-technical.md` | `tier3/audit/semantic/section/feature-technical/*.md` |
