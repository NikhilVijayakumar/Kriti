...
> *Deterministic rules for this domain: `common/tier8/audit/deterministic/document/readme.yaml`*
...
- [Systems README Conventions](#systems-readme-conventions)
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/04-purpose.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/01-project_name.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/02-short_description.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/03-overview.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/05-key_capabilities.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/06-repository_structure.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/07-documentation_structure.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/09-installation.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/10-build.yaml`*
...
> ```
>
> Produces `target/release/scheduler`.
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/11-usage.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/08-getting_started.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/14-configuration.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/12-development.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/13-contributing.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/readme/15-license.yaml`*
...
## Systems README Conventions

> *Structural rules: `common/tier8/audit/deterministic/section/readme/05-systems_readme.yaml`*
...
```markdown
A systems README must provide:

* Clear instructions on setting up the Rust toolchain (e.g., `rustup`).
* How to run `cargo build` and `cargo test`.
* Required system libraries or dependencies (e.g., `libssl-dev`).
```
...
### Examples
**Correct:**
> The README includes commands for installing rustup and running the tests.
...
- **Do:** Provide exact Cargo commands.
