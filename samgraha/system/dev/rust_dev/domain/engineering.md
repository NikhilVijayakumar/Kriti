...
> *Deterministic rules for this domain: `tier2/audit/deterministic/document/engineering.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/engineering/05-purpose.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/engineering/03-build_standards.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/engineering/04-testing_standards.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/engineering/06-code_standards.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/engineering/07-constraints.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/engineering/08-traceability.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/engineering/01-guiding_principles.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/engineering/02-rationale.yaml`*
...
When engineering systems in Rust, standards must dictate:

* **Ownership & Lifetimes:** Minimize lifetime annotations by using clear ownership transfers; avoid unnecessary borrowing.
* **Error Handling:** Use `thiserror` for libraries (to export concrete error types) and `anyhow` for applications. Never `unwrap()` in production code.
* **Async I/O:** Proper use of the async runtime (e.g., Tokio) without blocking the thread pool.
* **Unsafe Code:** `unsafe` is prohibited by default. If required, it must include a `// SAFETY:` comment proving the invariants.

## Ownership Patterns

> *Structural rules: `tier2/audit/deterministic/section/engineering/09-ownership_patterns.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/engineering/10-async_patterns.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/engineering/11-unsafe_guidelines.yaml`*
