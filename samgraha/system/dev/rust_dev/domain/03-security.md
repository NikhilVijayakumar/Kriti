...
> *Deterministic rules for this domain: `common/tier2/audit/deterministic/document/security.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/security/04-purpose.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/security/01-threat_model.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/security/02-data_classification.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/security/03-security_principles.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/security/07-compliance.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/security/08-incident_response.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/security/05-constraints.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/security/06-traceability.yaml`*
...
- [Vision Standard](vision.md) — Security derives from Vision
- [Philosophy Standard](philosophy.md) — Security derives from Philosophy
- [Architecture Standard](architecture.md) — has its own Security Considerations section that realizes this one structurally
- [Engineering Standard](engineering.md) — has its own Security Standards section that realizes this one at the tooling/code level
- [Feature Technical Standard](feature-technical.md) — has its own Security Considerations section that realizes this one per feature
...
> *Structural rules: `common/tier2/audit/deterministic/section/security/10-systems_security.yaml`*
...
```markdown
When defining security for systems engineering, focus on:

* **Memory Safety:** Rust's guarantees and handling of unsafe blocks.
* **Cryptography:** Use of audited cryptographic crates.
* **Supply Chain:** Auditing dependencies (`cargo-audit`).
```
...
### Examples
**Correct:**
> All cryptographic operations must use `rustls` and `ring`. The dependency graph is continuously scanned using `cargo-audit`.

**Incorrect:**
> We will try to keep the code secure.
...
- **Do:** Focus on memory safety and supply chain.
