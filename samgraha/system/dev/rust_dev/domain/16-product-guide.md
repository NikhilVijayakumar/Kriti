...
> *Deterministic rules for this domain: `common/tier8/audit/deterministic/document/product-guide.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/product-guide/03-purpose.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/product-guide/01-title.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/product-guide/02-body.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/product-guide/07-product_context.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/product-guide/08-public_contract.yaml`*
...
> *Structural rules: `common/tier8/audit/deterministic/section/product-guide/06-related.yaml`*
...
* Feature — for what a workflow is supposed to do
...
- [Readme Standard](readme.md) — the entry point Product Guide expands on
- [Build Standard](build.md) — install/run instructions Product Guide must stay accurate to
...
The product guide/help documentation should include developer workflow guides:

* How to add a new crate to the workspace.
* How to manage and bump dependency versions.
* Standard practices for writing inline doc tests and using `rustdoc`.
* How to run property tests and performance benchmarks locally.

## Development Workflow

> *Structural rules: `common/tier8/audit/deterministic/section/product-guide/09-development_workflow.yaml`*
