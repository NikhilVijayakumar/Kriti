...
> *Deterministic rules for this domain: `common/tier1/audit/deterministic/document/philosophy.yaml`*

## Table of Contents
- [Purpose](#purpose)
- [Systems Philosophy Addendum](#systems-philosophy-addendum)
...
> *Structural rules: `common/tier1/audit/deterministic/section/philosophy/04-purpose.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/philosophy/01-guiding_principles.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/philosophy/02-values.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/philosophy/03-tradeoffs.yaml`*
...
## Systems Philosophy Addendum

> *Structural rules: `common/tier1/audit/deterministic/section/philosophy/05-systems_philosophy.yaml`*
...
```markdown
The rust_dev system adds the following philosophical principles:
...
* **Safety as Default:** Zero `unsafe` in business logic; all edge cases encoded in the type system.
* **Performance Matters:** Mechanical sympathy with the hardware, predictable latency.
* **Explicit Over Implicit:** We prefer explicit lifetimes, explicit errors (`Result`), and explicit dependencies.
```
...
### Examples
**Correct:**
> We return `Result<T, AppError>` instead of panicking.
...
- **Do:** Emphasize safety and performance.
