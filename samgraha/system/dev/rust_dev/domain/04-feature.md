...
> *Deterministic rules for this domain: `common/tier2/audit/deterministic/document/feature.yaml`*

## Table of Contents
- [Purpose](#purpose)
- [Systems Feature Definition](#systems-feature-definition)
...
> *Structural rules: `common/tier2/audit/deterministic/section/feature/01-purpose.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/feature/02-functional_requirements.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/feature/04-business_rules.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/feature/07-constraints.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/feature/08-dependencies.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/feature/03-acceptance_criteria.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/feature/10-future_extensions.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/feature/09-non_goals.yaml`*
...
These belong to Architecture, Feature Technical Design, Engineering, or Implementation respectively — see Prohibited Content below for the full rationale table.

---

## Inputs

> *Structural rules: `common/tier2/audit/deterministic/section/feature/05-inputs.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/feature/06-outputs.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/feature/11-traceability.yaml`*
...
```text
Vision → Feature → Architecture → Feature Technical Design → Engineering → Implementation
```
...
> ```
>
> CloudBridge derives from the Vision goal of "automated data consistency across environments." Its Architecture must not contradict this intent.
...
Written by product owners/engineers before design or implementation starts — one file per capability. Use `samgraha audit --domain feature` to confirm every feature has Functional Requirements and Acceptance Criteria before it moves to Architecture and Feature Technical Design.
...
## Systems Feature Definition

> *Structural rules: `common/tier2/audit/deterministic/section/feature/10-systems_feature_definition.yaml`*
...
```markdown
When defining features for systems engineering, the focus must be on data contracts, state machines, and system capabilities.

* **API Contracts:** Define the input/output boundaries (e.g., gRPC, CLI args, messaging queues).
* **State Machines:** Define the internal state transitions.
* **Invariants:** What must always be true about the data.
```

**Required subsections:** API Contracts, State Machines
**Optional subsections:** Invariants
**Required diagrams:** none
**Required cross-references:** none

### Examples
**Correct:**
> The consensus feature accepts a `VoteRequest` message and transitions the state machine from `Follower` to `Candidate`.

**Incorrect:**
> The user clicks a button to vote.

### Writing Guidance
- **Tone:** authoritative
- **Voice:** third person
- **Structure:** bullets and paragraphs
- **Audience:** backend developers
- **Do:** Focus on contracts and state.
