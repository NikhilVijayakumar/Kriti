...
> *Deterministic rules for this domain: `common/tier2/audit/deterministic/document/external-context.yaml`*
...
- [Systems Technology Categories](#systems-technology-categories)
...
> *Structural rules: `common/tier2/audit/deterministic/section/external-context/01-purpose.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/external-context/02-integration_contract.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/external-context/03-constraints.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/external-context/04-dependencies.yaml`*
...
> *Structural rules: `common/tier2/audit/deterministic/section/external-context/05-traceability.yaml`*
...
## Systems Technology Categories

When documenting external context for a systems project, evaluate dependencies across these typical categories:

* **Async Runtimes:** Execution environments (e.g., Tokio, smol).
* **Serialization:** Data format translation (e.g., Serde, bincode).
* **Error Handling Libraries:** Standardized error reporting (e.g., anyhow, thiserror).
* **Networking & HTTP:** Low-level and high-level network clients (e.g., reqwest, hyper).
* **FFI & C Interop:** Binding generators for external C libraries (e.g., bindgen).

## Technology Categories

> *Structural rules: `common/tier2/audit/deterministic/section/external-context/06-systems_technology.yaml`*
...
```markdown
When documenting external context for a Rust system, evaluate dependencies across these typical categories:
...
### Examples
**Correct:**
> We depend on `tokio` for our async runtime and `serde` for serialization.

**Incorrect:**
> We use rust packages.
> *Why wrong: Too vague.*
...
- **Do:** Clearly identify the chosen crates.
