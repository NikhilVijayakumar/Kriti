...
> *Deterministic rules for this domain: `tier2/audit/deterministic/document/security.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/security/04-purpose.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/security/01-threat_model.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/security/02-data_classification.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/security/03-security_principles.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/security/07-compliance.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/security/08-incident_response.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/security/05-constraints.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/security/06-traceability.yaml`*
...
> *Structural rules: `tier2/audit/deterministic/section/security/10-systems_security.yaml`*
