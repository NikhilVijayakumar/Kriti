...
> *Deterministic rules for this domain: `common/tier1/audit/deterministic/document/vision.yaml`*

## Table of Contents
- [Purpose](#purpose)
- [Systems Engineering Vision](#systems-engineering-vision)
- [Vision](#vision)
- [Problem](#problem)
- [Solution](#solution)
...
> *Structural rules: `common/tier1/audit/deterministic/section/vision/01-purpose.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/vision/02-vision_statement.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/vision/03-problem.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/vision/04-solution.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/vision/05-target_audience.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/vision/06-pillars.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/vision/07-philosophy.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/vision/09-success_criteria.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/vision/10-traceability.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/vision/08-guiding_principles.yaml`*
...
> *Structural rules: `common/tier1/audit/deterministic/section/vision/05-systems_vision.yaml`*
...
```markdown
When defining the vision for systems engineering, focus on:

* **Performance:** Strict latency and throughput requirements.
* **Safety:** Memory safety and concurrency guarantees.
* **Modularity:** Isolation of concerns via distinct crates.
```
...
### Examples
**Correct:**
> The system will provide sub-millisecond p99 latency while guaranteeing memory safety across concurrent thread pools.

**Incorrect:**
> The system will have a fast UI.
> *Why wrong: Systems vision should focus on backend systems properties.*
...
- **Do:** Focus on performance and safety.
