...
## Backend Philosophy Addendum

> *Structural rules: `audit/deterministic/section/02-philosophy/05-backend_philosophy.yaml`*
...
```markdown
The FastAPI backend system adds the following philosophical principles:

* **Explicit Over Implicit:** Prefer explicit dependencies via DI and explicit type annotations.
* **Fail Fast at Boundaries:** Validate at entry points (Pydantic) and never let invalid data propagate.
...
### Examples
**Correct:**
> We use Pydantic models for all router inputs to fail fast.

**Incorrect:**
> We parse raw JSON dicts in the service layer.
...
- **Do:** Emphasize boundary validation.
