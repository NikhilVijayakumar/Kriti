...
- [Backend README Conventions](#backend-readme-conventions)
...
## Backend README Conventions

> *Structural rules: `audit/deterministic/section/15-readme/05-backend_readme.yaml`*
...
```markdown
A backend README must provide:

* Clear instructions on setting up the local development database and environment variables.
* How to run the local development server.
* How to access the local API documentation (e.g., /docs or /redoc).
* How to run the test suite and database migrations.
```
...
**Correct:**
> The README includes commands for starting Postgres via Docker, running Alembic migrations, and starting Uvicorn.

**Incorrect:**
> See the codebase to understand how to run it.
> *Why wrong: The README must explicitly provide run commands.*
...
- **Do:** Provide clear, copy-pasteable commands.
- **Don't:** Leave setup steps ambiguous.
