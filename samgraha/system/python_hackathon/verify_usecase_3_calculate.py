#!/usr/bin/env python3
"""verify_usecase_3_calculate.py — Verify leaderboard output has one entry per team, no None fields."""
import argparse
import json
import os
import sys
...
def main():
    ...
    # Check one entry per registered participant
    ...
    # Check no None fields in final_score
    for r in results:
